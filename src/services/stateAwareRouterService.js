...
const MEDIA_OS_WORDS = /(media\s*os|drive|google drive|диск|папк|директор|файл|видео|ролик|клип|медиафайл|asset|ассет|reference|референс|player cards|карточк|скриншот|сайт|фронтенд|frontend|stories|reels|рилс|карусел)/i;
...
const PLAYER_CARD_WORDS = /(player cards|карточк.*игрок|скриншот|скрин|сайт|фронтенд|frontend|profile card|player card)/i;
const CONTENT_TYPE_WORDS = /(тип.*контент|формат.*контент|stories|reels|рилс|карусел|папка видео|видео.*stories|видео.*рилс|что к чему подходит)/i;
